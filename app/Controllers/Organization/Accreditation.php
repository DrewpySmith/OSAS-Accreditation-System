...
class Accreditation extends BaseController
{
    ...
    public function index()
    {
        ...
        // Calculate Progress
        $progress = 0;
        $requiredFields = array_filter(array_keys(\App\Models\DocumentSubmissionModel::DOCUMENT_TYPES), function ($key) {
            return $key !== 'other';
        });
        ...
        if ($checklist) {
            ...
            $progress = count($requiredFields) > 0 ? round(($completedCount / count($requiredFields)) * 100) : 0;
        }
