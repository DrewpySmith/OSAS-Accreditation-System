        ...
        <aside id="sidebar"
            ...
            <nav class="flex-1 px-3 py-2 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <div class="space-y-1">
                    ...
                    <a href="<?= base_url('organization/announcements') ?>"
                        class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-all nav-item <?= $isActive('organization/announcements') ? 'bg-green-600 text-white' : 'text-muted-foreground hover:bg-muted hover:text-foreground' ?>"
                        title="Announcements">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-3 flex-shrink-0 nav-icon" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="<?= base_url('organization/chat') ?>"
                        class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-all nav-item <?= $isActive('organization/chat') ? 'bg-green-600 text-white' : 'text-muted-foreground hover:bg-muted hover:text-foreground' ?>"
                        title="Messages">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-3 flex-shrink-0 nav-icon" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
